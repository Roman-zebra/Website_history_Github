...
test('touch stick ramps speed, sprints at full tilt, and clears on release, cancellation and pause',()=>{
 ...
 function node(id){if(nodes.has(id))return nodes.get(id);const handlers={};const n={id,textContent:'',style:{},value:'1',options:[{}],selectedOptions:[{textContent:'1962'}],attrs:{},hidden:false,disabled:false,open:false,
 ...
 events['jta-walk-ready']();const stick=node('stick'),e=(x,y)=>({pointerId:1,clientX:x,clientY:y,preventDefault:noop});
