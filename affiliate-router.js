...
(function(root){
 ...
 function getYourGuide(config,place,lang){
  ...
  if(!eligible(config,place)||!g?.enabled||place.skipGyg||!['en','ja','ko','zh-Hans','zh-Hant'].includes(lang)||!/^[A-Z0-9]{5,12}$/.test(g.partnerId||''))return null;
 ...
 const api={select,travel,tourHub,tours,offerChoices,createRotation,getYourGuide,providerCopy,resolveOffer,distance,regional,trackedURL,createResolver,copy};if(typeof module==='object'&&module.exports)module.exports=api;else root.AffiliateRouter=api;
