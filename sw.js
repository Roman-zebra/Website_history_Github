...
const SHELL_FILES = [
  './japan-boundary.js?v=' + ASSET_V, './walking-data.js?v=' + ASSET_V, './walking-time.js?v=' + ASSET_V, './walking-time.css?v=' + ASSET_V,
  './', './index.html',
  ...
  './og.jpg',
  './icons/landmarks/himeji-castle-v1.webp', './icons/landmarks/mount-fuji-v1.webp', './icons/landmarks/tokyo-tower-v1.webp',
