...
Cache versions: renderer18, walk JS6/CSS5, buildings4, interiors3, navigation3. Verify the served HTML and both v3 assets after deployment. A dimensioned shrine stair survey is still required before replacing the inferred route with a measured reconstruction.
