...
const LANGS=[
 ...
 {code:'ja',dir:'ja/',html:'ja',hreflang:'ja',
  title:'よみがえる軍艦島（端島）｜全盛期の町並みと当時の暮らしを3Dで 1947年〜現在 | Japan Time Atlas',
  description:'よみがえる軍艦島。長崎・端島の全盛期の町並みと当時の暮らしを3Dで再現。1947年から最新まで5枚の空中写真を年代スライダーで切り替え、30号棟・65号棟・小中学校など建物が建った年と崩れた年、室内など12か所の再現を見られます。日本語と英語の音声ガイド付き。',
  crumb:'3Dでよみがえる',badge:'3Dでよみがえる · 1947年 → 現在'},
