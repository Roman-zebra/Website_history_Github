...
for(const p of places){
 ...
 const schema={'@context':'https://schema.org','@graph':[{'@type':'Article',headline:title,description,inLanguage:l,url:base+url,mainEntityOfPage:base+url,publisher:{'@type':'Organization',name:'Japan Time Atlas',url:base},about:{'@type':guides[p.id]?.schemaType||'Place',name,alternateName:p.name_ja,geo:{'@type':'GeoCoordinates',latitude:p.lat,longitude:p.lon}}},{'@type':'BreadcrumbList',itemListElement:[{'@type':'ListItem',position:1,name:t.home,item:base+(l==='en'?'/places':'/'+t.route)},{'@type':'ListItem',position:2,name,item:base+url}]}]};
