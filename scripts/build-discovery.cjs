...
function footer(l){const t=labels[l];return '<footer><p>Japan Time Atlas · <a href="/about#'+(l==='th'?'en':l)+'">'+t.about+'</a> · <a class="site-support-link" href="/support">'+t.support+'</a></p><p><a href="https://maps.gsi.go.jp/development/ichiran.html">GSI Tiles</a> · © <a href="https://www.openstreetmap.org/copyright">OpenStreetMap contributors</a> · Wikipedia (CC BY-SA)</p></footer></body></html>';}
