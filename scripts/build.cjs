...
const directories=['data','icons','3d','place','search','guides','visit','vendor','og'];
const files=['walking-data.js','walking-time.js','walking-time.css','activities-data.js','search-core.js','search-worker.js','visit.html','about.html','about.js','th.html','.nojekyll','LICENSE-DATA.md','_headers','_redirects','app.js','atmosphere.js','design.css','explore.css','explore.html','explore.js','explore.webmanifest','index.html','ja.html','kids.html','ko.html','loop.js','manifest.webmanifest','og.jpg','page.css','place-ui.js','places.html','share.js','robots.txt','sitemap.xml','553bf2e0eaae7329e0477ae46475d218.txt','style.css','sw.js','zh-cn.html','zh-tw.html'];
